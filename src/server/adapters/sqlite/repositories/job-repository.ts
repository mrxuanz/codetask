...
function toSettings(row: Row | undefined): JobSettingsRecord | null {
  ...
  return {
    ...
    workModel: (row.work_model as string | null) ?? null,
    ...
    workValidationModel: (row.work_validation_model as string | null) ?? null,
    ...
    sliceValidationModel: (row.slice_validation_model as string | null) ?? null,
    ...
    milestoneValidationModel: (row.milestone_validation_model as string | null) ?? null,
...
export class SqliteJobRepository implements JobRepository {
  ...
  putSettings(record: JobSettingsRecord, expectedRevision: number | null): boolean {
    const values = [
      ...
      record.milestoneValidationModel,
