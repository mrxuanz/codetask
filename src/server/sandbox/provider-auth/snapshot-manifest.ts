...
/**
 * Durably records exactly which credential materials were placed in a Provider runtime.
 * Entries can be narrow snapshots or read-only symbolic references. Startup cleanup only trusts
 * paths in this manifest and never searches workspaces by credential-like filenames.
 */
