...
export default {
  ...
  conversation: {
    ...
    chooseProvider: 'Choose a host runner',
    chooseProviderDescription:
      'Choose Codex, Claude Code, OpenCode, or Cursor per conversation. The host CLI owns the active model.',
    createThreadFromSidebar:
      'Use the “+” next to the project in the sidebar to choose a host runner and create a conversation.',
    noWorkspace: 'No workspace yet',
    emptyTitle: 'Start with a local folder',
    emptyDescription: 'Choose a workspace, then use any of the four host CLIs per conversation.',
    startHint: 'Send a message to start this conversation.',
    waiting: 'The host runner is replying…',
    thinking: 'Thinking',
    running: 'Running',
    noMessages:
      'Send a message to begin. Durable history remains available when the Provider changes.',
    ...
    settings: {
      title: 'Settings',
      description: 'Host runners, Planner, Job, sandbox, and account settings.',
      providersTitle: 'Host runners',
      providersDescription:
        'Check installation and host login for all four Providers. Each CLI owns its active model.',
