...
export default {
  ...
  conversation: {
    ...
    newThread: '新しい会話',
    noThreads: '会話はまだありません',
    threadTitle: '会話タイトル',
    chooseProvider: 'ホスト実行器を選択',
    chooseProviderDescription:
      '会話ごとに Codex、Claude Code、OpenCode、Cursor を選択します。モデルはホスト CLI の既定値を使用します。',
    createThreadFromSidebar:
      'サイドバーのプロジェクト右側にある「+」からホスト実行器を選択して会話を作成します。',
    noWorkspace: 'ワークスペースはまだありません',
    emptyTitle: 'ローカルフォルダから開始',
    emptyDescription: 'ワークスペースを選択し、会話ごとに 4 種類のホスト CLI を利用できます。',
    startHint: 'メッセージを送信して会話を開始します。',
    waiting: 'ホスト実行器が応答中…',
    thinking: '思考',
    running: '実行中',
    noMessages: 'メッセージを送信して開始します。Provider を変更しても履歴は維持されます。',
    promptPlaceholder: '実現したい内容を入力…',
    ...
    settings: {
      title: '設定',
      description: 'ホスト実行器、Planner、Job、サンドボックス、アカウント設定。',
      providersTitle: 'ホスト実行器',
      providersDescription:
        '4 種類の Provider のインストールとホストログインを確認します。モデルは各 CLI が管理します。',
