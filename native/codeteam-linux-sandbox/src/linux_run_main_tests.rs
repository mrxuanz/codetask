...
#[cfg(test)]
use codeteam_sandbox_policy::models::SandboxEnforcement;
#[cfg(test)]
use codeteam_sandbox_policy::protocol::FileSystemSandboxPolicy;
#[cfg(test)]
use codeteam_sandbox_policy::protocol::NetworkSandboxPolicy;
#[cfg(test)]
...
fn inserts_bwrap_argv0_before_command_separator() {
    ...
    apply_inner_command_argv0_for_launcher(
        &mut argv,
        /*supports_argv0*/ true,
        "/tmp/codex-arg0-session/codeteam-linux-sandbox".to_string(),
    );
    assert_eq!(
        argv,
        vec![
            ...
            "/proc".to_string(),
            "--argv0".to_string(),
            "codeteam-linux-sandbox".to_string(),
            "--".to_string(),
            "/bin/true".to_string(),
        ]
    );
...
fn split_only_filesystem_policy_requires_direct_runtime_enforcement() {
    ...
    let policy = FileSystemSandboxPolicy::restricted(vec![
        codeteam_sandbox_policy::permissions::FileSystemSandboxEntry {
            path: codeteam_sandbox_policy::permissions::FileSystemPath::Special {
                value: codeteam_sandbox_policy::permissions::FileSystemSpecialPath::project_roots(
                    /*subpath*/ None,
                ),
            },
            access: codeteam_sandbox_policy::permissions::FileSystemAccessMode::Write,
        },
        codeteam_sandbox_policy::permissions::FileSystemSandboxEntry {
            path: codeteam_sandbox_policy::permissions::FileSystemPath::Path { path: docs },
            access: codeteam_sandbox_policy::permissions::FileSystemAccessMode::Read,
        },
    ]);
...
fn root_write_read_only_carveout_requires_direct_runtime_enforcement() {
    ...
    let policy = FileSystemSandboxPolicy::restricted(vec![
        codeteam_sandbox_policy::permissions::FileSystemSandboxEntry {
            path: codeteam_sandbox_policy::permissions::FileSystemPath::Special {
                value: codeteam_sandbox_policy::permissions::FileSystemSpecialPath::Root,
            },
            access: codeteam_sandbox_policy::permissions::FileSystemAccessMode::Write,
        },
        codeteam_sandbox_policy::permissions::FileSystemSandboxEntry {
