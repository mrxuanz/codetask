...
#[cfg(target_os = "windows")]
#[path = "bin/setup_main/win/mod.rs"]
mod setup_win;

#[cfg(target_os = "windows")]
#[path = "bin/command_runner/win/mod.rs"]
...
#[cfg(target_os = "windows")]
pub use command_runner_win::run_command_runner;
#[cfg(target_os = "windows")]
...
#[cfg(target_os = "windows")]
pub use host_launcher::HostLauncher;
#[cfg(target_os = "windows")]
pub use host_launcher::apply_electron_node_env;
#[cfg(target_os = "windows")]
pub use host_launcher::electron_node_env_vars;
#[cfg(target_os = "windows")]
pub use host_launcher::resolve_host_launcher;
#[cfg(target_os = "windows")]
pub use host_launcher::write_host_launcher_config;
#[cfg(target_os = "windows")]
...
#[cfg(target_os = "windows")]
pub use setup_win::execute_setup_payload_b64;
#[cfg(target_os = "windows")]
#[doc(hidden)]
