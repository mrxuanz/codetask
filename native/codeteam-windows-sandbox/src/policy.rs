use anyhow::Result;
pub use codeteam_sandbox_policy::protocol::SandboxPolicy;
...
mod tests {
    ...
    fn rejects_external_sandbox_json() {
        let payload = serde_json::to_string(
            &codeteam_sandbox_policy::protocol::SandboxPolicy::ExternalSandbox {
                network_access: codeteam_sandbox_policy::protocol::NetworkAccess::Enabled,
            },
        )
        .unwrap();
