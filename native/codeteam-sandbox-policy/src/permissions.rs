...
use codeteam_utils_absolute_path::canonicalize_preserving_symlinks;
...
use crate::legacy::NetworkAccess;
use crate::legacy::SandboxPolicy;
use crate::legacy::WritableRoot;
...
const PROTECTED_METADATA_CODETEAM_PATH_NAME: &str = ".codeteam";
...
pub const PROTECTED_METADATA_PATH_NAMES: &[&str] = &[
    ...
    PROTECTED_METADATA_CODETEAM_PATH_NAME,
];
...
impl FileSystemSandboxPolicy {
    ...
    pub fn workspace_write(
        ...
        append_default_read_only_project_root_subpath_if_no_explicit_rule(&mut entries, ".codeteam");
