...
export function fetchAgentDefaults(): Promise<ApiSuccess<AgentDefaultsPayload>> {
...
): Promise<ApiSuccess<SettingsWriteResult<AgentDefaultsSettings>>> {
...
export function fetchPromptSettings(): Promise<ApiSuccess<PromptSettingsPayload>> {
...
export function updatePromptSettings(
  settings: AgentPromptSettings,
  expectedRevision: number
): Promise<ApiSuccess<SettingsWriteResult<AgentPromptSettings>>> {
...
export function fetchMcpSettings(): Promise<ApiSuccess<McpSettingsPayload>> {
...
export function updateMcpSettings(
  settings: AgentMcpSettings,
  expectedRevision: number
): Promise<ApiSuccess<SettingsWriteResult<AgentMcpSettings>>> {
...
export function fetchProviderSettings(): Promise<ApiSuccess<ProviderSettingsPayload>> {
...
export function updateProviderSettings(
  ...
  expectedRevision: number
): Promise<ApiSuccess<SettingsWriteResult<{ providers: Record<string, ProviderRuntimeSetting> }>>> {
...
export function fetchProviderCatalog(): Promise<ApiSuccess<{ providers: AgentCoreOption[] }>> {
  return api<{ providers: AgentCoreOption[] }>('/api/settings/provider-catalog')
}

export function fetchSecrets(): Promise<ApiSuccess<{ secrets: SecretMeta[] }>> {
...
export function putSecret(
  name: string,
  value: string
): Promise<ApiSuccess<{ secret: SecretMeta }>> {
...
export function deleteSecret(
  name: string
): Promise<ApiSuccess<{ deleted: boolean; name: string }>> {
