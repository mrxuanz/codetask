...
export default {
  ...
  workspace: {
    ...
    providerUnavailable: '現在の CLI は利用できません。インストールして再試行してください。',
    loadingMessages: 'メッセージを読み込み中…',
    loadOlderMessages: '以前のメッセージを読み込む',
    loadingOlderMessages: '以前のメッセージを読み込み中…',
    loadOlderMessagesFailed: '以前のメッセージを読み込めませんでした',
    loadThreadFailed: 'スレッドの読み込みに失敗しました',
    switchCoreFailed: 'CLI の切り替えに失敗しました',
    sendFailed: '送信に失敗しました',
    cancelTurnFailed: '生成の停止に失敗しました',
    logout: 'ログアウト',
