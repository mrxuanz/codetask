...
import { roleRequiresOuterSandbox } from './roles.ts'
...
import type { ProgressGuard } from './progress-guard.ts'
import type { AgentTurnChunk } from './types.ts'
import { noFirstSignalMsForRole } from './turn-timeouts.ts'
