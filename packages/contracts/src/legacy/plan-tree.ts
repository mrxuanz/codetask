import type { JobReferenceManifestDto, TaskAssignedReference } from './job-references.ts'
import type { TaskEvidenceDto } from '../ui-evidence.ts'
import { resolveAssignedReferencesFromDto } from './job-references.ts'
