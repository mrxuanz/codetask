...
} from './thread-plan-pointer-triggers.ts'
...
export const migration006DropLegacyJobJson: Migration = {
  version: 6,
  name: 'drop_legacy_job_json',
  up(db) {
    if (!columnExists(db, 'thread_jobs', 'abilities_json')) return
